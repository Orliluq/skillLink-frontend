...
const badgeRules = [
  {
    ...
    description: 'Comparte ideas, ayuda a otros y gana puntos por cada publicación o respuesta útil en el foro.',
    points: 10,
  ...
  },
  {
    ...
    description: 'Crea proyectos colaborativos o personales y publícalos en tu perfil.',
    points: 50,
  ...
  },
  {
    ...
    description: 'Impulsa a otros como mentor en sesiones o procesos de acompañamiento.',
    points: 75,
  ...
  },
  {
    ...
    description: 'Completa cursos disponibles en la plataforma y demuestra tu crecimiento.',
    points: 30,
